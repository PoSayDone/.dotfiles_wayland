...
export const PlayPauseButton = ({
    player,
    playing = Icon({ hexpand: true, halign: 'center', className: 'playing', icon: 'media-playback-pause-symbolic' }),
    paused = Icon({ hexpand: true, halign: 'center', className: 'paused', icon: 'media-playback-start-symbolic' }),
    stopped = Icon({ hexpand: true, halign: 'center', className: 'stopped', icon: 'media-playback-start-symbolic' }),
    ...props
} = {}) => PlayerButton({
    ...props,
    player,
